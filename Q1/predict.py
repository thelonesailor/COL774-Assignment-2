...
predicted=[]
def predict(textfile,outputfile):
...
# t is 0 based
	...
	# assert (t==mtest)		
	print("{} instances".format(t))
	# print("Using Naive Bayes        :\t{} correct  {}%".format(correct_nb, (correct_nb/t)*100))
	# print("Using Random class       :\t{} correct  {}%".format(correct_ran, (correct_ran/t)*100))
	# print("Using Most Occuring class:\t{} correct  {}%".format(correct_mo, (correct_mo/t)*100))
...
# 	# testing on testing set
# 	print("testing on stemmed testing set p1")
...
# 	# testing on testing set
# 	print("testing on stemmed testing set p2")
# 	predict("./imdb/imdb_test_text_st_p2.txt", "./imdb/imdb_test_labels.txt")
# 	print("")

# elif(sys.argv[1] == '4'):

# 	# testing on testing set
# 	print("testing on stemmed testing set p3")
# 	predict("./imdb/imdb_test_text_st_p3.txt", "./imdb/imdb_test_labels.txt")
# 	print("")
